...
build_time_vars = {
    ...
    "CONFIGURE_CFLAGS_NODIST": "-std=c11 -Werror=implicit-function-declaration -fvisibility=hidden",
    ...
    "CONFIG_ARGS": "'--build=aarch64-apple-darwin' '--host=aarch64-apple-darwin' '--prefix=/install' '--with-openssl=/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--enable-shared' '--with-build-python=/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/host/bin/python3.11' 'ac_cv_lib_intl_textdomain=no' 'ac_cv_func_ptsname_r=no' '--with-dbmliborder=ndbm' 'build_alias=aarch64-apple-darwin' 'host_alias=aarch64-apple-darwin' 'PKG_CONFIG=pkg-config --static' 'PKG_CONFIG_PATH=/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/deps/share/pkgconfig:/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/deps/lib/pkgconfig' 'CC=clang' 'CFLAGS=-arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch arm64 -mmacosx-version-min=11.0  ' 'CPPFLAGS=-arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new'",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.11",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13/lcov-report",
    ...
    "FREEZE_MODULE": "/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/host/bin/python3.11 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/host/bin/python3.11 ./Programs/_freeze_module.py",
    ...
    "LIBEXPAT_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBEXPAT_HEADERS": "\\",
    "LIBEXPAT_OBJS": "\\",
    "LIBFFI_INCLUDEDIR": "",
    "LIBM": "",
    ...
    "LLVM_PROF_MERGER": "/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/llvm/bin/llvm-profdata merge -output=code.profclangd *.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/host/bin/python3.11",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/host/bin/python3.11",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "PY_CFLAGS_NODIST": "-std=c11 -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal",
    ...
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13 _PYTHON_PROJECT_BASE=/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/host/bin/python3.11",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13 _PYTHON_PROJECT_BASE=/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/tools/host/bin/python3.11 ./Tools/scripts/run_tests.py",
    ...
    "abs_builddir": "/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13",
    "abs_srcdir": "/private/var/folders/3r/fh4222513gg9x1s90yjtg1b40000gn/T/tmpqbt5r69v/Python-3.11.13",
